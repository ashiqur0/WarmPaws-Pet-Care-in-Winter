...
const WinterCareTips = () => {
    ...
    return (
        <div className='my-10 md:w-7xl md:mx-auto mx-4'>
            ...
            <div className='border-l-4 border-slate-700 md:w-2/3 w-full pl-4 my-10'>
                <h2 className='text-xl font-medium mb-2'>🦶 3. Protect Their Paws</h2>
            ...
            <div className='border-l-4 border-slate-700 md:w-2/3 w-full pl-4 my-10'>
                <h2 className='text-xl font-medium mb-2'>🛁 5. Groom, But Don’t Overdo Baths</h2>
                <p>Regular grooming helps maintain healthy fur that provides insulation. Avoid over-bathing — too many baths can dry out your pet’s skin in the cold season.</p>
            </div>
